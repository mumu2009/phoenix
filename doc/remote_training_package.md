...
python tools\train_jepa_v2_speech.py `
    --data-dir <datasets-dir>\musan_16k `
    --out-dir <checkpoints-dir>\jepa_v2_speech_small `
    --scale small `
    --epochs 50 `
    --batch-size 32 `
    --lr 1e-3 `
...
python tools\export_jepa_v2_multimodal.py `
    --modality speech `
    --checkpoint <checkpoints-dir>\jepa_v2_speech_small\best.pt `
    --out-dir <checkpoints-dir>\jepa_v2_speech_small\onnx
```
...
python tools\train_jepa_v2_vision.py `
    ...
    --out-dir <checkpoints-dir>\jepa_v2_vision_small `
    --resnet resnet18 `
    --concept 128 `
    --decoder-pt none `
    --decoder-width 1.25 `
...
python tools\export_jepa_v2_multimodal.py `
    --modality image `
    --checkpoint <checkpoints-dir>\jepa_v2_vision_small\best.pt `
    --out-dir <checkpoints-dir>\jepa_v2_vision_small\onnx
```
...
Start-Process -FilePath python -ArgumentList @(
    ...
    "--data-dir", "<datasets-dir>\musan_16k",
    "--out-dir", "<checkpoints-dir>\jepa_v2_speech_medium",
    "--scale", "medium",
    "--epochs", "100",
    "--batch-size", "16",
    "--amp",
