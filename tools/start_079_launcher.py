...
OPTION_FIELDS: list[OptionField] = [
    ...
    OptionField("using_ollama", "Use Ollama Legacy Switch", "bool", True, "Inference", "Core", "using-ollama"),
    OptionField("ollama_fine_tuning", "Enable Ollama Fine Tuning", "bool", True, "Inference", "Core", "ollama-fine-tuning"),
