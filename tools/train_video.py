"""Train a scalable video autoencoder.
...
class VideoAutoencoder(nn.Module):
    def __init__(self, resnet_name='resnet18', concept=128, pretrained=True,
        ...
        super().__init__()
        self.concept = concept
        self.encoder = VideoEncoder(resnet_name, concept, pretrained, unfreeze)
        self.decoder = VideoDecoder(concept, dec_width, dec_depth, dec_channels, load_sd)
...
def main():
    ...
    parser.add_argument('--out-dir', default='checkpoints/video', help='checkpoint directory')
