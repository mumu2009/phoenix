...
print('split top:', dec['tokens'][0]['token'], repr(dec['tokens'][0]['piece']))

comp = post('/v1/completions', {'prompt': tokens, 'temperature': 0, 'max_tokens': 1, 'seed': 1})
print('std text:', repr(comp['choices'][0]['text']))
