...
set "COMMON_SOURCES=transformer_main.cpp transformer_ollama_fine_tuning.cpp addon.cpp addons\builtin_registry.cpp addons\math_addon.cpp addons\search_addon.cpp addons\computer_shell_addon.cpp addons\cli_json_addon.cpp addons\ThePlugInForSecurity\security_core.cpp addons\ThePlugInForSecurity\meme_tensor.cpp addons\ThePlugInForSecurity\security_addon.cpp loggerCXX.cpp DATABASE_079.cpp frontend_server.cpp speak_io.cpp model_lifecycle.cpp autonomy_stack.cpp v51_runtime.cpp external_runtime.cpp edge_platform.cpp gguf_tensor_parser.cpp physics_world_runtime.cpp emotion_system.cpp llamacpp_emotion_adjuster.cpp plugin_system.cpp modern_context_system.cpp semantic_unit.cpp concept_matrix.cpp primal_sensation.cpp instinct.cpp prompt_split.cpp external_mixed_modal_io.cpp multimodal_world_model.cpp local_onnx.cpp video_model.cpp audio_model.cpp graph_diffusion_summarizer.cpp memetic_existence.cpp hierarchical_memory.cpp model_deployment.cpp rdk_x5_bpu.cpp active_inference.cpp subconscious_profile.cpp sparse_block_matmul.cpp agi_action_registry.cpp web_search_engine.cpp mcp_client.cpp subprocess.cpp mission_lifecycle.cpp instance_registry.cpp emergency_stop.cpp module_overrides\adversarial_learner_advanced.cpp module_overrides\gnn_ga_learner_advanced.cpp module_overrides\reinforcement_learner_advanced.cpp module_overrides\async_task_system.cpp %BULLET3_EMBEDDED_SOURCES%"
